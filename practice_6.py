...
# Базовый класс - Машина, имеет кол-во топлива, может заправляться
# Грузовик (производный от Машина) имеет емкость кузова, скорость движения, расход топлива за час поездки
# может стоять под погрузкой/разгрузкой, ехать со скоростью
# Погрузчик (производный от Машина) имеет скорость погрузки, расход топлива в час при работе,
